...
xy_data_forward = np.load("../data/r_rec_subcrit_hopf_forward.npy")
xy_data_backward = np.load("../data/r_rec_subcrit_hopf_backward.npy")
...
ax.plot(xy_data_forward[:,0],xy_data_forward[:,1],c='k')
ax.plot(xy_data_backward[:,0],xy_data_backward[:,1],c='r')
...
plt.savefig("../graphics/spiking_dyn_xy_subcrit_hopf.svg")
